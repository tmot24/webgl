...
export const ColoredTriangle = memo(() => {
  ...
  useEffect(() => {
    ...
    const stride = FSIZE * 5;
    const offsetPosition = 0;
    const offsetColor = FSIZE * 2;
    // Количество вызовов вершинного шейдера (в данном случае это 3, вершины треугольника)
    const n = 3;
